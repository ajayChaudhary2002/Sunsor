      ...
      <div className={style.section4Container_foodContainerDiv}>
        <div className={style.section4Container_leftContainer}>
          ...
          <div className={style.section4Container_leftContainer_foodDiv}>
            <img src={samose} alt="" />
            <p className={style.section4Container_leftContainer_foodDiv_para1}>
              Recipes | Stories | Video
            </p>
            <p className={style.section4Container_leftContainer_foodDiv_para2}>
              Samosa Made from Sunsor Atta
            </p>
            <p className={style.section4Container_leftContainer_foodDiv_para3}>
              view more →
            </p>
          </div>
        </div>
        ...
        <div className={style.section4Container_rightContainer}>
          <div className={style.section4Container_rightContainer_leftPart}>
            <div className={style.section1Container_rightContainer_topDiv}>
              <p className={style.section1Container_rightContainer_topDiv_para}>
                Recipes | Stories{" "}
              </p>
              <p
                className={style.section1Container_rightContainer_topDiv_para2}
              >
                Delicious Dal Puri from Sunsor atta and Oil
              </p>
              <p
                className={style.section1Container_rightContainer_topDiv_para3}
              >
                It is a long established fact that a reader will be distracted
                by the readable content of a page when looking at its layout.
              </p>
              <p
                className={style.section1Container_rightContainer_topDiv_para4}
              >
                View More →
              </p>
            </div>
            ...
            <div className={style.section1Container_rightContainer_bottomDiv}>
              <img src={chaat} alt="" />
              <p
                className={style.section4Container_leftContainer_foodDiv_para1}
              >
                Recipes | Stories | Video
              </p>
              <p
                className={style.section4Container_leftContainer_foodDiv_para2}
              >
                Super Delicious Kachori from Sunsor atta and Oil
              </p>
              <p
                className={style.section4Container_leftContainer_foodDiv_para3}
              >
                view more →
              </p>
            </div>
            <div className={style.section4Container_rightContainer_rightPart}>
              <img src={puri} alt="" className={style.paniPuriImg} />
              <p
                className={
                  style.section4Container_rightContainer_rightPart_text
                }
              >
                View All →
              </p>
